...
export async function seed(knex) {
  ...
  const contractors = [
    ...
    // ── Additional HVAC ──
    { type: 'contractor', first_name: 'Team', last_name: 'Kennon', company: 'Kennon Heating, Air & Plumbing', title: 'Sales Manager', email: 'info@kennonhvac.com', phone: '(770) 637-2700', contractor_services: '["hvac","plumbing","water_heater"]', contractor_insurance_verified: true, contractor_rating: 4.9, contractor_group_rate_discount: 0.25, source: 'manual', notes: 'Family-owned 15+ yrs, 1,700+ reviews, 4.9 avg. A+ BBB. Best of Gwinnett 2023. Serves Cumming/Alpharetta/Suwanee. 24/7 emergency.' },
    { type: 'contractor', first_name: 'Team', last_name: 'Estes', company: 'Estes Services', title: 'Account Manager', email: 'info@estesair.com', phone: '(770) 422-2040', contractor_services: '["hvac","plumbing","electrical"]', contractor_insurance_verified: true, contractor_rating: 4.7, contractor_group_rate_discount: 0.22, source: 'manual', notes: '3-generation family business since 1949. Leading home comfort in Atlanta metro. 70+ years.' },
    { type: 'contractor', first_name: 'Team', last_name: 'Epic Air', company: 'Epic Air Heating & Cooling', title: 'Owner', email: 'info@epicairheatingandcooling.com', phone: '(770) 889-2422', contractor_services: '["hvac"]', contractor_insurance_verified: true, contractor_rating: 4.6, contractor_group_rate_discount: 0.25, source: 'manual', notes: '28+ years HVAC experience, Forsyth County specialist.' },
    { type: 'contractor', first_name: 'Team', last_name: 'Holtkamp', company: 'Holtkamp HVAC', title: 'Owner', email: 'info@holtkamphvac.com', phone: '(770) 888-4144', contractor_services: '["hvac"]', contractor_insurance_verified: true, contractor_rating: 4.7, contractor_group_rate_discount: 0.25, source: 'manual', notes: 'Serves Cumming/Suwanee, quick response times, professional service.' },
    // ── Additional Roofing ──
    { type: 'contractor', first_name: 'Team', last_name: 'DOM', company: 'DOM Roofing & Restoration', title: 'Project Manager', email: 'info@domroofing.com', phone: '(770) 232-4406', contractor_services: '["roofing","gutter_cleaning"]', contractor_insurance_verified: true, contractor_rating: 4.8, contractor_group_rate_discount: 0.22, source: 'manual', notes: 'GAF Master Elite (top 2%), Sugar Hill/Suwanee based. Free roof inspection with gutter cleaning.' },
    { type: 'contractor', first_name: 'Team', last_name: 'Clark Bros', company: 'Clark Brothers Roofing', title: 'Sales Manager', email: 'info@clarkbrothersroofing.com', phone: '(770) 676-5818', contractor_services: '["roofing"]', contractor_insurance_verified: true, contractor_rating: 4.8, contractor_group_rate_discount: 0.20, source: 'manual', notes: 'Veteran-owned, CertainTeed SELECT ShingleMasters (top 1%). Family-led.' },
    { type: 'contractor', first_name: 'Team', last_name: 'Perimeter', company: 'Perimeter Roofing', title: 'Area Manager', email: 'info@perimeterroofing.com', phone: '(770) 615-3550', contractor_services: '["roofing"]', contractor_insurance_verified: true, contractor_rating: 4.7, contractor_group_rate_discount: 0.20, source: 'manual', notes: 'CertainTeed SELECT ShingleMaster, serves Alpharetta and north metro.' },
    // ── Additional Painting / Deck ──
    { type: 'contractor', first_name: 'Team', last_name: 'Kimberly', company: 'Kimberly Painting', title: 'Sales Director', email: 'info@kimberlypainting.com', phone: '(770) 888-6470', contractor_services: '["exterior_paint","deck_staining"]', contractor_insurance_verified: true, contractor_rating: 4.8, contractor_group_rate_discount: 0.25, source: 'manual', notes: 'Locally owned since 2005. Serves Alpharetta/Cumming/Suwanee/Duluth/Johns Creek/Milton/Roswell. Strong reviews.' },
    { type: 'contractor', first_name: 'Team', last_name: 'Three Brothers', company: 'Three Brothers Painting', title: 'Owner', email: 'info@threebrotherspainting.com', phone: '(770) 552-1620', contractor_services: '["exterior_paint"]', contractor_insurance_verified: true, contractor_rating: 4.7, contractor_group_rate_discount: 0.25, source: 'manual', notes: '30+ years trusted, North Metro Atlanta. Known for punctuality and clear communication.' },
    { type: 'contractor', first_name: 'Team', last_name: 'Fillo', company: 'Fillo Painting', title: 'Owner', email: 'info@fillopainting.com', phone: '(770) 769-7941', contractor_services: '["exterior_paint","deck_staining"]', contractor_insurance_verified: true, contractor_rating: 4.6, contractor_group_rate_discount: 0.25, source: 'manual', notes: 'North Metro Atlanta residential/commercial. Cumming/Alpharetta/Woodstock/Kennesaw/Canton/Roswell/Suwanee.' },
    { type: 'contractor', first_name: 'Team', last_name: 'Atlanta Deck Doc', company: 'Atlanta Deck Doctor', title: 'Owner', email: 'info@atlantadeckdoctor.com', phone: '(404) 992-4870', contractor_services: '["deck_staining"]', contractor_insurance_verified: true, contractor_rating: 4.9, contractor_group_rate_discount: 0.25, source: 'manual', notes: '272+ five-star reviews, 22+ video testimonials. Deck cleaning, staining, sealing, refurbishing. Alpharetta/Roswell.' },
    // ── Pressure Washing / Gutter ──
    { type: 'contractor', first_name: 'Josh', last_name: 'Team', company: 'Josh Pressure Wash & Roof Cleaning', title: 'Owner', email: 'info@joshpressurewash.com', phone: '(770) 365-6055', contractor_services: '["pressure_washing","gutter_cleaning"]', contractor_insurance_verified: true, contractor_rating: 4.9, contractor_group_rate_discount: 0.35, source: 'manual', notes: '235 reviews, EXCELLENT rating. Best of Forsyth, Best of Georgia nominee.' },
    { type: 'contractor', first_name: 'Team', last_name: 'WiseGuys', company: 'WiseGuys Pro-Wash', title: 'Owner', email: 'info@wiseguysprowash.com', phone: '(770) 544-9274', contractor_services: '["pressure_washing"]', contractor_insurance_verified: true, contractor_rating: 4.8, contractor_group_rate_discount: 0.35, source: 'manual', notes: 'Serving Alpharetta since 2014. Highest-rated power washing in wider Atlanta area. 10+ yrs experience.' },
    { type: 'contractor', first_name: 'Team', last_name: 'First In', company: 'First In Pressure Washing', title: 'Owner', email: 'info@firstinpw.com', phone: '(404) 609-9668', contractor_services: '["pressure_washing"]', contractor_insurance_verified: true, contractor_rating: 4.9, contractor_group_rate_discount: 0.35, source: 'manual', notes: '4.9 rating (80 reviews), eco-friendly, family-owned. Suwanee and surrounding area.' },
    { type: 'contractor', first_name: 'Team', last_name: 'ABG Cleaners', company: "Atlanta's Best Gutter Cleaners", title: 'Manager', email: 'info@atlantasbestguttercleaners.com', phone: '(770) 677-6690', contractor_services: '["gutter_cleaning"]', contractor_insurance_verified: true, contractor_rating: 4.6, contractor_group_rate_discount: 0.30, source: 'manual', notes: '4.6 stars (248 reviews). Serves 27 cities incl Alpharetta/Cumming/Suwanee. Clean from roof, not ladders. Since 1998 concept.' },
    { type: 'contractor', first_name: 'Team', last_name: 'Advanced PG', company: 'Advanced Pressure & Gutter Cleaning', title: 'Owner', email: 'info@advancedpressureandgutter.com', phone: '(770) 501-8604', contractor_services: '["pressure_washing","gutter_cleaning"]', contractor_insurance_verified: true, contractor_rating: 4.8, contractor_group_rate_discount: 0.30, source: 'manual', notes: '5-star Home Services Review, in business since 1991. Alpharetta/Cumming area.' },
    // ── Plumbing / Water Heater ──
    { type: 'contractor', first_name: 'Team', last_name: 'My GA Plumber', company: 'My Georgia Plumber', title: 'Service Manager', email: 'info@mygeorgiaplumber.com', phone: '(770) 268-2331', contractor_services: '["plumbing","water_heater"]', contractor_insurance_verified: true, contractor_rating: 4.6, contractor_group_rate_discount: 0.30, source: 'manual', notes: '4.6 Google (1,502 reviews). Same-day water heater install. Canton/Alpharetta/Woodstock.' },
    { type: 'contractor', first_name: 'Team', last_name: 'Aaron', company: 'Aaron Services', title: 'Account Manager', email: 'info@chooseaaronservices.com', phone: '(770) 888-3816', contractor_services: '["plumbing","hvac","water_heater"]', contractor_insurance_verified: true, contractor_rating: 4.8, contractor_group_rate_discount: 0.25, source: 'manual', notes: '40+ years serving North Atlanta. Thousands of 5-star reviews. No pressure/gimmicks. Suwanee/Roswell/Alpharetta/Cumming/Johns Creek.' },
    { type: 'contractor', first_name: 'Team', last_name: 'Greenlee', company: 'Greenlee Plumbing', title: 'Owner', email: 'info@greenleeplumbing.com', phone: '(678) 386-7513', contractor_services: '["plumbing","water_heater"]', contractor_insurance_verified: true, contractor_rating: 4.7, contractor_group_rate_discount: 0.30, source: 'manual', notes: '20+ years. Same-day/24hr service. Hall/Gwinnett/Forsyth/N. Fulton/Cobb counties.' },
    // ── Garage Door ──
    { type: 'contractor', first_name: 'Team', last_name: 'Top Notch GD', company: 'Top Notch Garage Door', title: 'Owner', email: 'info@topnotchgaragedoor.com', phone: '(770) 888-3420', contractor_services: '["garage_door"]', contractor_insurance_verified: true, contractor_rating: 4.9, contractor_group_rate_discount: 0.20, source: 'manual', notes: 'A+ BBB, 950+ 5-star reviews. Fastest response in Forsyth County. Spring/cable/track/opener repair + replacement.' },
    { type: 'contractor', first_name: 'Team', last_name: 'Precision GD', company: 'Precision Garage Door', title: 'Area Manager', email: 'info@precisiondooratlanta.com', phone: '(770) 995-1066', contractor_services: '["garage_door"]', contractor_insurance_verified: true, contractor_rating: 4.9, contractor_group_rate_discount: 0.18, source: 'manual', notes: '4.89 stars (479 reviews) in Cumming. Expert installation, professional and polite.' },
    { type: 'contractor', first_name: 'Team', last_name: 'Graves', company: 'Graves Overhead Doors', title: 'Owner', email: 'info@gravesoverheaddoors.com', phone: '(770) 735-4890', contractor_services: '["garage_door"]', contractor_insurance_verified: true, contractor_rating: 4.6, contractor_group_rate_discount: 0.20, source: 'manual', notes: 'Family owned since 1998. North Atlanta: Cumming/Canton/Duluth/Alpharetta.' },
    // ── Driveway Sealing ──
    { type: 'contractor', first_name: 'Team', last_name: 'Blackjack', company: 'Blackjack Paving', title: 'Sales Manager', email: 'info@blackjackpaving.com', phone: '(404) 924-8680', contractor_services: '["driveway_sealing"]', contractor_insurance_verified: true, contractor_rating: 4.5, contractor_group_rate_discount: 0.30, source: 'manual', notes: 'Most trusted sealcoating in GA/Southeast. Fully licensed, bonded, insured.' },
    // ── Landscaping / Lawn (bonus — potential partnership) ──
    { type: 'contractor', first_name: 'Team', last_name: 'Pannone', company: "Pannone's Lawn Pros & Landscaping", title: 'Owner', email: 'info@pannoneslandscaping.com', phone: '(678) 935-6524', contractor_services: '["landscaping"]', contractor_insurance_verified: true, contractor_rating: 4.7, contractor_group_rate_discount: 0.25, source: 'manual', notes: 'Top Client Rated, Nextdoor Neighborhood Favorite. 10+ yrs Forsyth County. Deep local knowledge.' },
    { type: 'contractor', first_name: 'Team', last_name: 'Absolute', company: 'Absolute Lawn Pros', title: 'Owner', email: 'info@absolutelawnpros.com', phone: '(770) 777-0007', contractor_services: '["landscaping"]', contractor_insurance_verified: true, contractor_rating: 4.6, contractor_group_rate_discount: 0.25, source: 'manual', notes: '25+ years. Money-back guarantee. Cumming/Alpharetta/Johns Creek/Suwanee.' },
  ];
